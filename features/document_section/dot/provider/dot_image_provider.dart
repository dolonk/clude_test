...
class DotImageProvider extends ChangeNotifier {
  ...
  DotImageProvider({required List<String> filePaths}) {
  ...
  Future<void> cropPdfPagesBySize({required List<Uint8List> cropImage}) async {
    // print("cropImage: ${cropImage.length}");
    // print("selectedPaperHeight: $selectedPaperHeight");
    ...
    for (int i = 0; i < cropImage.length; i++) {
      ...
      // print("Auto crop width: $cropWidth1");
      // print("Auto crop height: $cropHeight1");
      // print('isAutoCropPercent new : $isAutoCropPercent');
